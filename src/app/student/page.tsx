...
const Page = () => {
  ...
  return (<Layout title="참여학생">
    <div>
      <Form onSubmit={postData}>
      <Form.Group>
        <Form.Label>이름:</Form.Label>
        <Form.Control type="text" placeholder="이름을 입력하세요" name="name" value={formData.name} onChange={handleChange}/>
      </Form.Group>
      ...
      <Form.Group>
        ...
        <Form.Control as="textarea" rows={3} placeholder="한 줄 소개를 입력하세요" name="bio" value={formData.bio} onChange={handleChange}/>
      </Form.Group>
